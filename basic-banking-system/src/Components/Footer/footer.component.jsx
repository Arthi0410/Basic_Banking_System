        ...
        <>
            ...
            <div className="footer">
                ...
                <div className='barnch'>
                    <h3 className='text-xl'>Our branches</h3>
                    Hyderabad<br />
                    Mumbai<br />
                    Bengaluru<br />
                </div>
                ...
                <div className="contact">
                    ...
                    <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new"><p>Email: arthichebrolu@gmail.com</p></a>
